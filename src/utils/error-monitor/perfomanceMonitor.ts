...
class PerformanceMonitor {
  ...
  constructor() {
    ...
    this.reportingEnabled = import.meta.env.VITE_PERFORMANCE_MONITORING === 'true'
  ...
  trackApiRequest(method: string, url: string, duration: number, status: number): void {
...
export const usePerformanceMonitor = () => {
  return {
    ...
    trackApiRequest: performanceMonitor.trackApiRequest.bind(performanceMonitor),
