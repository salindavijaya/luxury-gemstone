<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div
      class="relative bg-gradient-to-r from-slate-800 to-slate-900 overflow-hidden"
    >
      ...
      >
        <div class="text-center lg:text-left">
          <!-- Breadcrumb -->
          <nav
            class="flex justify-center lg:justify-start mb-6"
          ...
          <!-- Category Stats -->
          <div
            class="flex flex-wrap justify-center lg:justify-start gap-6 text-white/80"
          >
            <div class="text-center lg:text-left">
    ...
    <div class="bg-white border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div
              class="inline-flex items-center justify-center w-12 h-12 bg-emerald-100 text-emerald-600 rounded-lg mb-4"
            >
        ...
        >
          <div class="h-full flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto p-4 lg:p-0">
              ProductFiltersComponent as ProductFilters,
            </div>
          </div>
        </div>
...
import ProductGridSkeleton from "@/features/products/components/ProductGridSkeleton.vue";
...
const { filters, hasActiveFilters, clearAllFilters, setFilter } = useFilters();
...
const categoryData = computed(() => {
  const categories = {
    diamonds: {
      name: "Diamonds",
      description:
        "Discover our exquisite collection of certified diamonds, each one carefully selected for its exceptional brilliance and quality.",
      heroImage:
      ...
      education: {
        ...
        content:
          "<p>Learn about the 4Cs of diamonds - Cut, Color, Clarity, and Carat weight - and how they determine a diamond's beauty and value.</p>",
        image:
    ...
    sapphires: {
      name: "Sapphires",
      description:
        "Explore our stunning sapphire collection featuring the finest blue, pink, yellow, and rare padparadscha sapphires.",
      heroImage:
      ...
      education: {
        ...
        content:
          "<p>Discover the fascinating world of sapphires, from the legendary Kashmir blues to the rare padparadscha variety.</p>",
        image:
          "https://images.unsplash.com/photo-1544816155-12df9643f363?w=600&h=400&fit=crop",
    ...
    emeralds: {
      name: "Emeralds",
      description:
        "Behold our collection of vivid green emeralds, nature's most captivating gemstone with unparalleled color intensity.",
      heroImage:
        "https://images.unsplash.com/photo-1583037189850-1921ae7c6c22?w=1200&h=600&fit=crop",
      avgRating: 4.7,
      features: [
        {
          title: "Vivid Color",
      ...
      education: {
        ...
        content:
          "<p>Learn about emerald formation, the significance of origin, and how to appreciate these magnificent green gems.</p>",
        image:
          "https://images.unsplash.com/photo-1589674781759-c21c37956a44?w=600&h=400&fit=crop",
    ...
    rubies: {
      name: "Rubies",
      description:
        "Experience the fiery passion of our ruby collection, featuring the world's most coveted red gemstones.",
      heroImage:
      ...
      education: {
        title: "Ruby Royalty",
        content:
          "<p>Explore the rich history and exceptional characteristics that make rubies the king of colored gemstones.</p>",
        image:
