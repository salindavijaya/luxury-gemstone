 ...
 */
export const requiresManager = requiresRole(['manager', 'admin', 'super_admin'])

/**
 * Common permission guards
 */
export const canManageProducts = requiresPermission(['manage_products', 'admin'])
...
export const canViewReports = requiresPermission(['view_reports', 'admin', 'manager'])
