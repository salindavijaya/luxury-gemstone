    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
        ...
        <div class="bg-gray-50 px-4 py-5 sm:p-6">
          ...
          <div class="mb-8">
            <h4 class="text-lg font-medium text-gray-900 mb-4">Visual Size Comparison</h4>
            <div class="bg-white rounded-lg p-8 flex items-center justify-center space-x-12">
              <!-- Penny -->
              <div class="text-center">
                <div class="w-16 h-16 bg-amber-400 rounded-full flex items-center justify-center mb-2 border-2 border-amber-600">
              ...
              <div class="text-center">
                <div 
                  ...
                  :style="{ width: `${getVisualSize()}px`, height: `${getVisualSize()}px` }"
                >
                  <span class="text-xs font-bold text-white">{{ product.carat }}ct</span>
                </div>
                <p class="text-sm font-medium text-gray-700">{{ product.name }}</p>
                <p class="text-xs text-gray-500">~{{ getApproximateSize() }}mm</p>
              </div>

              <!-- Dime -->
              <div class="text-center">
                <div class="w-12 h-12 bg-gray-400 rounded-full flex items-center justify-center mb-2 border-2 border-gray-600">
              ...
              <!-- Quarter -->
              <div class="text-center">
                <div class="w-20 h-20 bg-gray-400 rounded-full flex items-center justify-center mb-2 border-2 border-gray-600">
          ...
          <!-- Carat Weight Chart -->
          <div class="mb-8">
            <h4 class="text-lg font-medium text-gray-900 mb-4">Carat Weight Reference</h4>
            <div class="bg-white rounded-lg p-6">
              <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div 
                  ...
                  :class="weight.carat === product.carat ? 'bg-emerald-100 border-2 border-emerald-500' : 'bg-gray-50'"
                >
                  <div 
                    ...
                    :style="{ 
                      ...
                      backgroundColor: weight.carat === product.carat ? '#059669' : '#6B7280'
                    }"
                  >
                    <span 
                      class="text-xs font-bold"
                      :class="weight.carat === product.carat ? 'text-white' : 'text-white'"
                    >
                      {{ weight.carat }}
                    </span>
                  </div>
                  <p class="text-sm font-medium text-gray-700">{{ weight.carat }} carat</p>
                  <p class="text-xs text-gray-500">~{{ weight.diameter }}mm</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Shape Variations -->
          <div class="mb-8">
            <h4 class="text-lg font-medium text-gray-900 mb-4">Shape Impact on Appearance</h4>
            <div class="bg-white rounded-lg p-6">
              <p class="text-sm text-gray-600 mb-4">
                The same carat weight can appear different in size depending on the shape:
              </p>
              <div class="grid grid-cols-3 md:grid-cols-6 gap-4">
                <div 
                  ...
                  :class="shape.name === product.shape ? 'bg-emerald-100' : 'bg-gray-50'"
                >
                  ...
                  <p class="text-xs font-medium text-gray-700">{{ shape.name }}</p>
          ...
          <!-- Helpful Tips -->
          <div>
            <h4 class="text-lg font-medium text-gray-900 mb-4">Size Selection Tips</h4>
            <div class="bg-white rounded-lg p-6">
              <ul class="space-y-3 text-sm text-gray-600">
                <li class="flex items-start space-x-2">
                  <LightBulbIcon class="w-4 h-4 text-amber-500 mt-0.5 flex-shrink-0" />
                  <span>Consider finger size - larger stones may look disproportionate on smaller fingers</span>
                </li>
                <li class="flex items-start space-x-2">
                  <LightBulbIcon class="w-4 h-4 text-amber-500 mt-0.5 flex-shrink-0" />
                  <span>Shape affects perceived size - elongated shapes appear larger than round ones</span>
                </li>
                <li class="flex items-start space-x-2">
                  <LightBulbIcon class="w-4 h-4 text-amber-500 mt-0.5 flex-shrink-0" />
                  <span>Setting style impacts visual size - halo settings make stones appear larger</span>
                </li>
                <li class="flex items-start space-x-2">
                  <LightBulbIcon class="w-4 h-4 text-amber-500 mt-0.5 flex-shrink-0" />
                  <span>View in person when possible - photos may not accurately represent scale</span>
                </li>
              </ul>
            </div>
          </div>
...
import { XMarkIcon, RulerIcon, LightBulbIcon } from '@heroicons/vue/24/outline'
