      ...
      <div class="flex flex-col lg:flex-row gap-8">
            ...
            <ul class="space-y-2">
              ...
              <li>
                ...
                >
                  ...
                  <span
                    v-if="orderCount > 0"
                    class="ml-auto inline-block bg-emerald-100 text-emerald-800 text-xs px-2 py-1 rounded-full"
                  >
                    {{ orderCount }}
                  </span>
                </button>
        ...
        <main class="flex-1 min-w-0">
          ...
          <div v-if="activeTab === 'overview'" class="space-y-6">
            <!-- Welcome Section -->
            <div
              class="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-lg shadow-lg p-6 text-white"
            >
              ...
              <div v-if="recentOrders.length > 0" class="space-y-4">
                ...
                >
                  <div class="flex items-center space-x-4">
                    <div
                      class="w-12 h-12 bg-slate-100 rounded-md flex items-center justify-center"
                    >
                      <svg
...
// State
const activeTab = ref<"overview" | "orders" | "profile" | "addresses">(
  "overview"
);
