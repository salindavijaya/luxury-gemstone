<template>
    <div class="bg-white rounded-lg shadow-lg p-6">
      ...
      <div class="flex items-center mb-8">
        ...
        <div class="ml-6">
          ...
          <p class="text-sm text-slate-500">Member since {{ formatDate(user?.createdAt) }}</p>
        </div>
      </div>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <!-- Date of Birth -->
        <div class="space-y-2">
          <label for="dateOfBirth" class="block text-sm font-medium text-slate-700">
            Date of Birth
          </label>
          <input
            id="dateOfBirth"
            ...
            :class="[
              'w-full px-3 py-2 border rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500',
              !isEditing ? 'bg-slate-50 text-slate-600 cursor-not-allowed' : 'bg-white',
              validationErrors.dateOfBirth ? 'border-red-500' : 'border-slate-300'
            ]"
              ...
              <div class="relative">
                <input
                  ...
                  :class="[
                    ...
                    validationErrors.currentPassword ? 'border-red-500' : 'border-slate-300'
                  ]"
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <input
                  ...
                  :class="[
                    'w-full px-3 py-2 pr-10 border rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500',
                    validationErrors.newPassword ? 'border-red-500' : 'border-slate-300'
                  ]"
  ...
  const { validateRequired, validateEmail, validatePhone, validatePassword } = useValidation()
