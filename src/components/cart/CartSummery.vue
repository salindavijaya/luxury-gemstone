<template>
  <div class="bg-slate-50 rounded-lg p-6 space-y-4">
    ...
    <h3
      class="text-lg font-semibold text-slate-800 border-b border-slate-200 pb-2"
    >
      Order Summary
    </h3>
    ...
    <div class="space-y-3">
      ...
      <div class="flex justify-between text-sm">
        ...
        <span v-if="shippingCost === 0" class="text-emerald-600 font-medium"
          >Free</span
        >
      ...
      <div v-if="insuranceCost > 0" class="flex justify-between text-sm">
        ...
        <span class="text-slate-800 font-medium"
          >${{ formatPrice(insuranceCost) }}</span
        >
      </div>
      ...
      <div
        ...
        class="bg-slate-100 rounded-md p-3 text-xs text-slate-600"
      >
        <p class="mb-2">
          <strong>Comprehensive Coverage:</strong> Protection against loss,
          theft, and damage during transit and beyond.
        </p>
      ...
      <div v-if="specialHandling > 0" class="flex justify-between text-sm">
        ...
        <span class="text-slate-800 font-medium"
          >${{ formatPrice(specialHandling) }}</span
        >
      </div>
    </div>
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <div class="bg-white rounded border border-slate-200 px-2 py-1">
          <svg class="w-8 h-5" viewBox="0 0 32 20" fill="none">
            ...
            <path
              d="M8 7H12L10 10L12 13H8L6 10L8 7ZM16 7H20V8.5H16V7ZM16 9H19V10.5H16V9ZM16 11H20V12.5H16V11Z"
              fill="white"
            />
          </svg>
        </div>
    ...
    <div class="border-t border-slate-200 pt-4">
      <div
        class="flex items-center justify-center gap-4 text-xs text-slate-500"
      >
        <div class="flex items-center gap-1">
          <svg
        ...
        <div class="flex items-start gap-2">
          ...
          <div>
            ...
            <p class="text-xs text-amber-700 mt-1">
              All gemstones come with certified authenticity and 30-day return
              policy.
            </p>
          </div>
        </div>
    ...
    <div class="border-t border-slate-200 pt-4">
      ...
      <div v-else class="space-y-2">
        ...
        <div
          v-if="appliedPromo"
          class="flex items-center justify-between bg-emerald-50 border border-emerald-200 rounded-md px-3 py-2"
        >
