  ...
  <div class="space-y-6">
            ...
            <div class="flex-1">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    <p class="font-medium text-slate-800">Credit or Debit Card</p>
                ...
                <div class="flex space-x-2">
                  ...
                  <img src="https://js.stripe.com/v3/fingerprinted/img/amex-a49b82f46c5cd31dc8da3270a3aa16dd.svg" alt="American Express" class="h-6 w-auto">
                </div>
              </div>
            </div>
            <div 
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-500">Pay with your PayPal account</p>
                  </div>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
      ...
      <div class="mt-2 flex justify-between items-center">
        <p class="text-xs text-slate-500">Optional: Add any special instructions or requests</p>
      ...
      <div class="space-y-4">
        <label class="flex items-start space-x-3">
          ...
          <div>
            ...
            <p class="text-sm text-slate-500">Include gift wrapping and message</p>
          </div>
        </label>
        ...
        <div v-if="isGift" class="ml-6 space-y-4 animate-slide-down">
          <div>
            ...
            <textarea
              ...
              maxlength="250"
            ></textarea>
            <p class="mt-1 text-xs text-slate-500">{{ giftMessage.length }}/250 characters</p>
          </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              >
                <input
                  ...
                  class="sr-only"
                >
                <img :src="wrap.image" :alt="wrap.name" class="w-12 h-12 object-cover rounded mb-2">
                <p class="text-sm font-medium text-slate-800 text-center">{{ wrap.name }}</p>
                <p class="text-xs text-slate-500 text-center">${{ wrap.price }}</p>
              </label>
            </div>
          </div>
        </div>
...
const isFormValid = computed(() => {
  if (selectedPaymentMethod.value === 'card') {
    return cardData.value.number && cardData.value.expiry && 
           cardData.value.cvc && cardData.value.name &&
           Object.keys(paymentErrors.value).length === 0
  }
  
  if (!sameAsShipping.value) {
    return billingAddress.value.firstName && billingAddress.value.lastName &&
           billingAddress.value.address1 && billingAddress.value.city &&
...
const checkApplePaySupport = () => {
  if (window.ApplePaySession) {
    applePaySupported.value = ApplePaySession.canMakePayments()
  }
}
