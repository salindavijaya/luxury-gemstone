  ...
  <div class="space-y-4">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-2">
        ...
        />
        <label for="same-as-shipping" class="text-sm text-slate-700 cursor-pointer">
    ...
    <div class="space-y-3">
      <div class="flex items-center space-x-2">
        ...
        />
        <label for="business-purchase" class="text-sm text-slate-700 cursor-pointer">
      ...
      >
        <div v-if="isBusinessPurchase" class="overflow-hidden ml-6 space-y-3">
          <div>
            <label for="tax-id" class="block text-sm font-medium text-slate-700 mb-1">
              Tax ID / VAT Number
            </label>
            <input
              id="tax-id"
...
const taxRate = computed(() => {
  const address = sameAsShipping.value ? props.shippingAddress : billingAddress.value
...
const emitUpdate = () => {
  const billingData: BillingData = {
    address: sameAsShipping.value ? props.shippingAddress : billingAddress.value,
    sameAsShipping: sameAsShipping.value,
    isBusinessPurchase: isBusinessPurchase.value,
