<template>
  <div class="error-boundary">
    ...
    <!-- Error Display -->
    <div v-else class="error-container bg-red-50 border border-red-200 rounded-lg p-6 m-4">
      ...
      <div v-if="!isDevelopment" class="text-center">
        ...
        <h2 class="text-xl font-semibold text-red-800 mb-2">{{ errorTitle }}</h2>
      ...
      <div v-else class="space-y-4">
        ...
        <div v-if="error?.stack" class="bg-gray-100 border rounded-lg p-4">
          ...
          <pre class="text-sm text-gray-700 overflow-x-auto whitespace-pre-wrap">{{ error.stack }}</pre>
        </div>
...
import { ref, onErrorCaptured, provide, inject, computed, onMounted } from 'vue'
...
const errorLogger = inject('errorLogger', null)
...
Please describe what you were doing when this error occurred:
  ...
  window.open(`mailto:support@gemstoneluxury.com?subject=${subject}&body=${body}`)
}
