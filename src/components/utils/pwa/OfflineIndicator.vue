    ...
    >
      <div class="flex items-center justify-between max-w-7xl mx-auto">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <p class="text-sm font-medium">You're currently offline</p>
            <p class="text-xs opacity-90">
              Some features may be limited. We'll sync your data when you're
              back online.
            </p>
          </div>
        </div>
...
const {
  isOnline,
  checkConnection: baseCheckConnection,
  isChecking,
} = useOnlineStatus();
