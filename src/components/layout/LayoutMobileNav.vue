    ...
    >
      ...
      >
        ...
        <div class="p-6 border-b border-slate-200/50">
          ...
          >
            <div
              class="w-10 h-10 bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-full flex items-center justify-center"
            >
        ...
        <div class="px-6 py-4 space-y-1">
          ...
          <RouterLink
            ...
            :class="{
              'bg-emerald-50 text-emerald-600': $route.path === link.path,
            }"
          >
        ...
        <div
          v-if="authStore.isAuthenticated"
          class="px-6 py-4 border-t border-slate-200/50"
        >
          <h3
            class="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-3"
          >
        ...
        <div class="px-6 py-4 border-t border-slate-200/50 mt-auto">
          ...
          <!-- Social Links -->
          <div
            class="flex items-center space-x-4 mt-4 pt-4 border-t border-slate-200/50"
          >
            <a
...
const socialLinks = [
  {
    name: "Facebook",
    icon: FacebookIcon,
    url: "https://facebook.com/luxegems",
  },
  { name: "Twitter", icon: TwitterIcon, url: "https://twitter.com/luxegems" },
  {
    name: "Instagram",
    icon: InstagramIcon,
    url: "https://instagram.com/luxegems",
  },
];
...
const handleSignOut = async (): Promise<void> => {
  try {
    // guard: setLoading may be a loosely typed store method
    (uiStore as any).setLoading?.(true);
    ...
    (uiStore as any).setLoading?.(false);
  }
};
