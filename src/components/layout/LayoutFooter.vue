      ...
      >
        ...
        <div class="lg:col-span-1">
          ...
          <p class="text-slate-300 text-sm leading-relaxed mb-6">
            Discover the world's finest gemstones and luxury jewelry. Each piece
            is carefully selected and crafted to perfection, bringing you
          ...
          <div class="sr-only">
            <svg xmlns="http://www.w3.org/2000/svg" style="display: none">
              <symbol id="FacebookIcon" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
                  d="M18.77 7.46H15.5v-1.9c0-.9.6-1.1 1-1.1h2.2V.5h-3C13.5.5 12 2 12 4.6v2.86h-2V12h2v12h4V12h2.5l.27-4.54z"
                />
              </symbol>
              ...
              <symbol id="PinterestIcon" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
              ...
              <symbol id="ShieldCheckIcon" viewBox="0 0 24 24">
                <path
                  stroke="currentColor"
              ...
              <symbol id="TruckIcon" viewBox="0 0 24 24">
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM21 17a2 2 0 11-4 0 2 2 0 014 0zM1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"
                />
              </symbol>
              <symbol id="RefreshIcon" viewBox="0 0 24 24">
                <path
                  stroke="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li v-for="link in quickLinks" :key="link.name">
              ...
              >
                <svg
                  class="w-4 h-4 mr-2 opacity-0 group-hover:opacity-100 transform translate-x-0 group-hover:translate-x-1 transition-all duration-200"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div>
          ...
          <div class="space-y-3">
            <div class="flex items-center text-slate-300 text-sm">
              <svg
                class="w-4 h-4 mr-3 text-emerald-500 flex-shrink-0"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div class="flex items-start text-slate-300 text-sm">
              <svg
                class="w-4 h-4 mr-3 text-emerald-500 flex-shrink-0 mt-0.5"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div class="flex items-center text-slate-300 text-sm">
              ...
              <a
                href="mailto:info@gemstonecollection.com"
    ...
    <div class="border-t border-slate-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <!-- Trust Badges -->
          <div
            class="flex flex-wrap items-center justify-center lg:justify-start space-x-6 lg:space-x-8"
          >
            <div
            ...
            >
              <div
                class="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center group-hover:bg-emerald-600/20 transition-colors"
              >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        >
          ...
          <div class="text-slate-400 text-sm">
            <p>
              &copy; {{ currentYear }} Gemstone Collection. All rights reserved.
            </p>
          </div>
