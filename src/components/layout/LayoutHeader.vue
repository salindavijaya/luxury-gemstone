<template>
  <header
    class="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-200/50 transition-all duration-300"
  >
      ...
      <div class="flex items-center justify-between h-16 lg:h-20">
        ...
        <div class="flex items-center">
          ...
          >
            <div class="relative">
              <div
                class="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg flex items-center justify-center shadow-lg transform group-hover:scale-105 transition-transform duration-200"
              >
                <svg
            ...
            <div class="hidden sm:block">
              <h1
                class="text-xl lg:text-2xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent"
              >
                Gemstone
              </h1>
        ...
        <div class="hidden lg:flex items-center space-x-6">
          ...
          <div class="flex items-center space-x-4">
            ...
            >
              ...
              >
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 2.5M7 13l2.5 2.5m6-2.5L17.5 18.5M17.5 18.5L20 21"
                />
              </svg>
              <span
            ...
            <div class="relative" ref="userMenuRef">
              ...
              >
                <div
                  class="w-8 h-8 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center"
                >
                  <svg
                    v-if="!user"
...
const toggleCart = (): void => {
  // UI store exposes toggleCartSidebar helper
  (uiStore as any).toggleCartSidebar?.();
};
