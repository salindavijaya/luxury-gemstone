<template>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 transition-colors duration-300">
      ...
      <div class="flex flex-col min-h-screen">
        <!-- Header -->
        <header class="sticky top-0 z-30 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 shadow-sm">
          <LayoutHeader />
        </header>
          ...
          >
            ...
            >
              <div class="text-center space-y-4">
                <!-- Loading Spinner -->
                <div class="relative">
                  <div class="w-12 h-12 border-4 border-emerald-200 dark:border-emerald-800 rounded-full animate-spin">
                    <div class="absolute top-0 left-0 w-full h-full border-4 border-transparent border-t-emerald-600 rounded-full animate-spin"></div>
                  </div>
                </div>
                ...
                <div class="space-y-2">
                  ...
                  >
                    <div
                      ...
                      :style="{ width: `${uiStore.primaryLoadingState.progress}%` }"
                    ></div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="flex items-center justify-center min-h-[50vh]">
                    <div class="text-center space-y-4">
                      <div class="inline-flex items-center space-x-2">
                        ...
                        <span class="text-slate-600 dark:text-slate-400">Loading page...</span>
                      </div>
                    </div>
                  </div>
                </template>
  ...
  const getToastIcon = (type: string) => {
    ...
    return iconComponents[type as keyof typeof iconComponents] || iconComponents.info
  }
  </script>
