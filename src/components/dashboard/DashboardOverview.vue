...
<template>
  <div class="space-y-6">
    <!-- Welcome Section -->
    <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-lg p-6 text-white">
      <div class="flex items-center justify-between">
        ...
        <div class="text-right">
          ...
          <p class="text-2xl font-bold">{{ user?.loyaltyPoints.toLocaleString() }}</p>
        </div>
      </div>
    </div>
          ...
          <div v-else class="space-y-4">
            ...
            >
              <div class="flex items-center space-x-3">
                ...
                >
                <div>
                  <p class="font-medium text-slate-900">Order #{{ order.orderNumber }}</p>
                  <p class="text-sm text-slate-500">{{ formatDate(order.date) }}</p>
                </div>
              </div>
              <div class="text-right">
