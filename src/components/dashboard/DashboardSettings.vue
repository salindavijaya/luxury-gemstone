<template>
  <div class="space-y-8">
    ...
    <div>
      ...
      <p class="text-slate-600 mt-1">Manage your account preferences and security settings</p>
    </div>

    <!-- Profile Information -->
    <div class="bg-white rounded-lg border border-slate-200 p-6">
      <h3 class="text-lg font-medium text-slate-900 mb-6">Profile Information</h3>
    ...
    <div class="bg-white rounded-lg border border-slate-200 p-6">
      ...
      <div class="space-y-6">
        ...
        <div class="flex items-center justify-between py-4 border-b border-slate-200">
          <div>
            <h4 class="text-sm font-medium text-slate-900">Two-Factor Authentication</h4>
        ...
        <div class="py-4">
          <div class="flex items-center justify-between mb-4">
            <div>
              <h4 class="text-sm font-medium text-slate-900">Active Sessions</h4>
              <p class="text-sm text-slate-600">Manage your active login sessions</p>
            </div>
            <button
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-xs text-slate-600">{{ session.location }} • {{ session.lastActive }}</p>
                </div>
              </div>
              <button
              ...
              <span v-else class="text-xs text-emerald-600 font-medium">Current</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white rounded-lg border border-slate-200 p-6">
      ...
      <div class="space-y-6">
        ...
        <!-- SMS Notifications -->
        <div>
          <h4 class="text-sm font-medium text-slate-900 mb-4">SMS Notifications</h4>
          <div class="space-y-3">
            <label
        ...
        <!-- Push Notifications -->
        <div>
          <h4 class="text-sm font-medium text-slate-900 mb-4">Push Notifications</h4>
          <div class="space-y-3">
            <label
    ...
    <div class="bg-white rounded-lg border border-slate-200 p-6">
      ...
      <div class="space-y-6">
        <label class="flex items-center justify-between">
          <div>
            <span class="text-sm font-medium text-slate-700">Profile Visibility</span>
            <p class="text-xs text-slate-500">Allow others to see your profile information</p>
          </div>
          <input
        ...
        <label class="flex items-center justify-between">
          <div>
            <span class="text-sm font-medium text-slate-700">Purchase History</span>
            <p class="text-xs text-slate-500">Show purchase history in public wishlists</p>
          </div>
          <input
        ...
        <label class="flex items-center justify-between">
          <div>
            <span class="text-sm font-medium text-slate-700">Data Analytics</span>
            <p class="text-xs text-slate-500">Help improve our service with usage analytics</p>
          </div>
          <input
        ...
        <label class="flex items-center justify-between">
          <div>
            <span class="text-sm font-medium text-slate-700">Marketing Communications</span>
            <p class="text-xs text-slate-500">Receive personalized offers and recommendations</p>
          </div>
          <input
    ...
    <!-- Account Management -->
    <div class="bg-white rounded-lg border border-slate-200 p-6">
      <h3 class="text-lg font-medium text-slate-900 mb-6">Account Management</h3>
      
      <div class="space-y-6">
        <div class="flex items-center justify-between py-4 border-b border-slate-200">
          <div>
            <h4 class="text-sm font-medium text-slate-900">Export Data</h4>
            <p class="text-sm text-slate-600">Download a copy of your account data</p>
          </div>
          <button
            @click="exportData"
            class="px-4 py-2 text-sm font-medium text-slate-600 bg-slate-100 rounded-md hover:bg-slate-200 transition-colors"
        ...
        <div class="flex items-center justify-between py-4 border-b border-slate-200">
          <div>
            <h4 class="text-sm font-medium text-slate-900">Deactivate Account</h4>
            <p class="text-sm text-slate-600">Temporarily disable your account</p>
          </div>
          <button
  ...
  if (confirm('Are you sure you want to permanently delete your account? This action cannot be undone and all your data will be lost.')) {
    if (confirm('This is your final warning. Are you absolutely sure you want to delete your account permanently?')) {
      notificationsStore.addNotification({
        ...
        message: 'Your account will be deleted in 30 days. You can cancel this action by contacting support.'
      })
    }
  }
}
