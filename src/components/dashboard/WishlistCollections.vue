<template>
  <div class="wishlist-collections">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
      <h2 class="text-2xl font-bold text-slate-800 mb-4 sm:mb-0">My Collections</h2>
      <button
    ...
    <!-- Collections Grid -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" v-if="collections.length > 0">
      <div
      ...
      >
        <!-- Collection Cover -->
        <div class="relative h-48 bg-gradient-to-br from-emerald-50 to-emerald-100">
          <div
          ...
          <div class="absolute bottom-2 left-2">
            <span class="px-2 py-1 bg-white/90 text-slate-800 text-sm rounded-full font-medium">
        ...
        <!-- Collection Info -->
        <div class="p-4">
          <h3 class="font-semibold text-slate-800 mb-1">{{ collection.name }}</h3>
          ...
          <div class="flex items-center justify-between text-sm text-slate-500 mb-3">
            ...
            <span v-if="collection.isPublic" class="text-emerald-600 font-medium">Public</span>
          </div>
    ...
    <div v-else class="text-center py-12">
      ...
      <h3 class="text-lg font-semibold text-slate-800 mb-2">No Collections Yet</h3>
      <p class="text-slate-600 mb-6 max-w-md mx-auto">
        Create collections to organize your wishlist items by occasion, style, or any way you prefer.
      </p>
      <button
        @click="showCreateModal = true"
      ...
      <div v-if="viewingCollection">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <p class="text-emerald-600 font-semibold mb-2">${{ item.price.toLocaleString() }}</p>
            <div class="flex space-x-2">
              <button
        ...
        items: [
          {
            ...
            price: 3299,
            image: 'https://images.unsplash.com/photo-1635767582909-bb9a3aa87e5b?w=400',
            category: 'Earrings'
          }
        ],
        isPublic: false,
