    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
      <div class="flex flex-wrap items-center gap-3">
        ...
        <div class="flex flex-wrap gap-2 flex-1">
          ...
          <!-- Price Range Filter -->
          <FilterTag
            v-if="activeFilters.priceRange && (activeFilters.priceRange.min > 0 || activeFilters.priceRange.max < 100000)"
          ...
          <!-- Carat Weight Filter -->
          <FilterTag
            v-if="activeFilters.caratRange && (activeFilters.caratRange.min > 0 || activeFilters.caratRange.max < 10)"
