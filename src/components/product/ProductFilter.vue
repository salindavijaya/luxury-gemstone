<template>
        ...
        <div class="space-y-3">
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <span class="ml-auto text-xs text-gray-500">({{ cert.count }})</span>
            </label>
          </div>
        </div>
        ...
        <div class="space-y-3">
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <span class="ml-auto text-xs text-gray-500">({{ origin.count }})</span>
            </label>
          </div>
        </div>
  ...
  // Composables
  const { filters, clearAllFilters, toggleArrayFilter, removeFilter } = useFilters()
  ...
  const activeFilterBreadcrumbs = computed(() => {
    ...
    filters.value.origins.forEach(origin => {
      const originLabel = origins.find(o => o.value === origin)?.label || origin
      breadcrumbs.push({
        key: 'origins',
        value: origin,
        label: originLabel
