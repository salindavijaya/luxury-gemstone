...
type CartStoreOperations = {
  ...
  updateShipping: (amount: number) => Promise<void>;
  updateTax: (amount: number) => Promise<void>;
};

type CartStore = CartStoreState & CartStoreOperations;
