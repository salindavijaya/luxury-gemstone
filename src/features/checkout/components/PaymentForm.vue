<template>
  <div class="space-y-6">
    ...
    <div class="space-y-3">
      ...
      <div class="grid grid-cols-1 gap-3">
        ...
        <label
          ...
          :class="{
            'border-emerald-500 bg-emerald-50': paymentMethod === 'credit_card',
          }"
        >
          <input
          ...
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center">
              <div
                class="w-5 h-5 border-2 border-slate-300 rounded-full mr-3 flex items-center justify-center"
                :class="{
                  'border-emerald-500': paymentMethod === 'credit_card',
                }"
              >
                <div
        ...
        <label
          class="relative flex items-center p-4 border border-slate-300 rounded-lg cursor-pointer hover:bg-slate-50 transition-colors"
          :class="{
            'border-emerald-500 bg-emerald-50': paymentMethod === 'paypal',
          }"
        >
          <input
            v-model="paymentMethod"
        ...
        <label
          ...
          class="relative flex items-center p-4 border border-slate-300 rounded-lg cursor-pointer hover:bg-slate-50 transition-colors"
          :class="{
            'border-emerald-500 bg-emerald-50': paymentMethod === 'apple_pay',
          }"
        >
          <input
            v-model="paymentMethod"
    ...
    <div
      v-if="paymentMethod === 'credit_card'"
      class="space-y-4 p-4 border border-slate-200 rounded-lg bg-slate-50"
    >
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div
            v-if="showCvvHelp"
            class="mt-2 p-3 bg-white border border-slate-200 rounded-lg shadow-lg text-sm"
          >
            <p class="text-slate-700 mb-2">
              Your CVV is the security code on your card:
            </p>
    ...
    <div
      v-if="paymentMethod === 'paypal'"
      class="p-4 border border-slate-200 rounded-lg bg-slate-50"
    >
    ...
    <div
      class="flex items-center justify-center space-x-4 p-4 bg-slate-50 rounded-lg"
    >
      <ShieldCheckIcon class="h-6 w-6 text-emerald-600" />
      <div class="text-sm text-slate-700">
        <span class="font-medium">Secure Payment</span> - Your payment
    ...
    <!-- Trust Badges -->
    <div
      class="flex items-center justify-center space-x-6 py-4 border-t border-slate-200"
    >
      <img
...
// State
const paymentMethod = ref<"credit_card" | "paypal" | "apple_pay">(
  props.value.method
);
...
const isValid = computed(() => {
  ...
  const hasAllFields = requiredFields.every(
    (field) => cardInfo[field as keyof CardInfo]
  );
