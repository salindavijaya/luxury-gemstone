  ...
  <div class="min-h-screen bg-slate-50 py-8">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-slate-600">Thank you for your purchase. Your order has been received and is being processed.</p>
      </div>

      <!-- Order Details Card -->
      <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        <div class="border-b border-slate-200 pb-4 mb-4">
          <h2 class="text-lg font-semibold text-slate-900 mb-2">Order Details</h2>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              <span class="text-slate-600">Order Number:</span>
              <span class="font-medium text-slate-900 ml-2">#{{ order.orderNumber }}</span>
            </div>
            <div>
              <span class="text-slate-600">Order Date:</span>
              <span class="font-medium text-slate-900 ml-2">{{ formatDate(order.orderDate) }}</span>
            </div>
            <div>
              <span class="text-slate-600">Total Amount:</span>
              <span class="font-medium text-emerald-600 ml-2">${{ order.total.toFixed(2) }}</span>
            </div>
            <div>
              <span class="text-slate-600">Payment Method:</span>
              <span class="font-medium text-slate-900 ml-2">{{ order.paymentMethod }}</span>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center justify-between mt-1">
                  <span class="text-sm text-slate-600">Qty: {{ item.quantity }}</span>
        ...
        <div class="border-t border-slate-200 pt-4">
          <h3 class="font-semibold text-slate-900 mb-3">Shipping Information</h3>
          <div class="bg-slate-50 rounded-lg p-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <h4 class="font-medium text-slate-900 mb-2">Delivery Details</h4>
                <div class="text-slate-600 space-y-1">
      ...
      <!-- What's Next Card -->
      <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        <h2 class="text-lg font-semibold text-slate-900 mb-4">What Happens Next?</h2>
        <div class="space-y-4">
          <div class="flex items-start space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-slate-600">You'll receive an email confirmation shortly with your order details.</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-3">
            ...
            <div>
              <h3 class="font-medium text-slate-900">Processing & Authentication</h3>
              <p class="text-sm text-slate-600">Our experts will verify and prepare your gemstones with proper certification.</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-slate-600">Your items will be shipped with full insurance and tracking information.</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-slate-600">Receive your luxury gemstones with authentication certificates.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="text-center mt-8 p-4 bg-amber-50 rounded-lg">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center text-sm">
          <a href="tel:+1-800-GEM-SHOP" class="text-amber-800 hover:text-amber-900 font-medium">
            📞 1-800-GEM-SHOP
          </a>
          <a href="mailto:support@luxurygemstones.com" class="text-amber-800 hover:text-amber-900 font-medium">
