    ...
    <div class="bg-white rounded-lg shadow-sm border">
      <div class="p-6 border-b border-slate-200">
        ...
        <p class="text-sm text-slate-600 mt-1">
          import { useCartStore } from '@/features/cart/store';lease review all
      ...
      <div class="p-6 space-y-6">
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-slate-600">
                  {{ item.gemstone }} • {{ item.certification }}
                </p>
              ...
              <div class="text-right">
                ...
                <p v-if="item.quantity > 1" class="text-sm text-slate-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div class="text-sm text-slate-600 space-y-1">
                  ...
                  <p v-if="shippingAddress.address2">
              ...
              <div>
                ...
                <div class="text-sm text-slate-600">
                  ...
                  <p
                    v-if="selectedShipping.estimatedDelivery"
          ...
          <div class="bg-slate-50 rounded-lg p-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div class="text-sm text-slate-600">
                  <p v-if="paymentData.sameAsShipping">
                  ...
                  <div v-else class="space-y-1">
                    ...
                    <p v-if="billingAddress.address2">
        ...
        <!-- Order Preferences -->
        <div
          v-if="orderPreferences.notes || orderPreferences.isGift"
            ...
            <div v-if="orderPreferences.isGift">
              ...
              <div class="space-y-2">
                <p class="text-sm text-slate-600">
                  ...
                  {{ getGiftWrapName(orderPreferences.giftWrap) }}
                </p>
                <div v-if="orderPreferences.giftMessage">
                  <p class="text-sm font-medium text-slate-700">
                    Gift Message:
                  </p>
                  <p class="text-sm text-slate-600 italic mt-1">
                    "{{ orderPreferences.giftMessage }}"
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <span class="text-emerald-600"
              >-${{ cartStore.discount.toLocaleString() }}</span
            >
          </div>
          <div class="flex justify-between text-sm">
          ...
          <div v-if="giftWrapCost > 0" class="flex justify-between text-sm">
            ...
            <span class="text-slate-800"
              >${{ giftWrapCost.toLocaleString() }}</span
            >
          </div>
          <div class="flex justify-between text-sm">
            <span class="text-slate-600">Tax</span>
            <span class="text-slate-800"
              >${{ cartStore.tax.toLocaleString() }}</span
            >
          </div>
    ...
    <div class="bg-slate-50 rounded-lg border p-4">
      <label class="flex items-start space-x-3">
        ...
        <div class="text-sm text-slate-600">
          ...
          <p class="mt-1">
            I understand that all gemstones are certified authentic and come
...
const giftWrapCost = computed(() => {
  if (!orderPreferences.value.isGift || !orderPreferences.value.giftWrap)
    return 0;
  return (
    giftWrapOptions[
      orderPreferences.value.giftWrap as keyof typeof giftWrapOptions
    ]?.price || 0
  );
});
...
const finalTotal = computed(() => {
  return (
    cartStore.total + (selectedShipping.value.price || 0) + giftWrapCost.value
  );
});
...
const getGiftWrapName = (wrapId: string) => {
  return (
    giftWrapOptions[wrapId as keyof typeof giftWrapOptions]?.name || "Unknown"
  );
};
...
const placeOrder = async () => {
  ...
  try {
    ...
    const order = {
      ...
      billingAddress: paymentData.value.sameAsShipping
