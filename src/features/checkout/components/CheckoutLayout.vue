      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-8">
        ...
        <div class="lg:col-span-8">
          ...
          <div class="bg-white rounded-lg shadow-lg p-6 sm:p-8">
            ...
            <!-- Navigation Buttons -->
            <div class="flex flex-col sm:flex-row justify-between gap-4 mt-8 pt-6 border-t border-slate-200">
              <button
                v-if="currentStep > 1"
                @click="previousStep"
              ...
              <div class="sm:ml-auto">
                ...
                >
                  ...
                  <svg v-if="currentStep < steps.length" class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2">
                <p class="text-sm text-slate-500">
                  Our luxury jewelry experts are here to assist you with your purchase.
                </p>
                <div class="mt-4 space-y-3">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm text-slate-700">+1 (555) 123-GEMS</span>
                  </div>
                  <div class="flex items-center gap-2">
                    <svg class="w-4 h-4 text-emerald-600" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span class="text-sm text-slate-700">support@luxgems.com</span>
                  </div>
                  <div class="flex items-center gap-2">
                    <svg class="w-4 h-4 text-emerald-600" fill="currentColor" viewBox="0 0 20 20">
...
// Computed properties
const currentStepData = computed(() => steps[props.currentStep - 1] || steps[0])
