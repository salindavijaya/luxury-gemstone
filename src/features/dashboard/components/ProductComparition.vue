<template>
  <div class="bg-white rounded-lg shadow-lg p-6">
    ...
    carat: 6.8, cut: Cut.Excellent, color: Color.F, clarity: Clarity.VS1,
    certification: { agency: "GIA", number: "GIA1234567" },!-- Add Products
    Section -->
    <div class="mb-6">
      <div class="flex flex-wrap gap-2 mb-4">
        ...
        >
          <div v-if="comparisonItems[slot - 1]" class="text-center">
            <img
              :src="
                (comparisonItems[slot - 1].images?.[0] as Image)?.url ||
                comparisonItems[slot - 1].image
              "
      ...
      <table class="w-full">
        ...
        <tbody class="divide-y divide-slate-200">
          ...
          <tr>
            ...
            >
              {{ item.specs?.carat || item.carat || 0 }} ct
            </td>
          </tr>
          ...
          <tr>
            ...
            <td
              ...
              class="py-4 px-2 text-center"
            >
              {{ item.specs?.clarity || item.clarity || "-" }}
            </td>
          </tr>
          ...
          <tr>
            ...
            >
              {{
                ...
                (item.certification?.agency
                  ? `${item.certification.agency} ${item.certification.certificateNumber || ""}`.trim()
                  : "-")
              }}
            </td>
          </tr>
...
import type { Product, Image } from "@/features/products/store";
import {
  Cut,
  Color,
  Clarity,
...
const availableProducts = ref<Product[]>([
  ...
  },
  {
    ...
    color: Color.D,
    clarity: Clarity.FL,
    certification: { agency: "GIA", number: "GIA7654321" },
  ...
  },
  {
    ...
    color: Color.F,
    clarity: Clarity.VS1,
    certification: { agency: "GRS", number: "GRS7890123" },
  ...
  },
  {
    ...
    color: Color.E,
    clarity: Clarity.VS2,
    certification: { agency: "GIA", number: "GIA0987654" },
  ...
  },
  {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1588444837495-c6cfeb53ff5d?w=400",
      },
    ],
    carat: 2.8,
    cut: Cut.VeryGood,
    color: Color.D,
    clarity: Clarity.VS1,
    certification: { agency: CertificationAgency.GIA, number: "GIA789012" },
