          ...
          <div class="flex items-center justify-between mb-3">
            <div>
              ...
              <span
                ...
                class="text-sm text-slate-400 line-through ml-2"
              >
            ...
            <div class="flex items-start justify-between">
              <div class="flex-1 mr-4">
                ...
                <div class="flex items-center space-x-4 text-xs text-slate-400">
                  ...
                  <span
                    v-if="item.product.certification"
              ...
              <div class="flex flex-col items-end space-y-3">
                <div class="text-right">
                  ...
                  <span
                    v-if="item.product.originalPrice"
                    class="block text-sm text-slate-400 line-through"
                  >
                    ${{ item.product.originalPrice.toFixed(2) }}
                  </span>
                </div>
...
const toggleCollectionMenu = (itemId: string) => {
  showCollectionMenu.value =
    showCollectionMenu.value === itemId ? null : itemId;
};
