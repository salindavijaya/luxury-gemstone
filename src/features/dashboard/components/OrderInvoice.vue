...
<template>
  <div class="max-w-4xl mx-auto bg-white">
    <div class="p-8 print:p-0">
      <!-- Header -->
      <div
        class="flex justify-between items-start mb-8 pb-8 border-b border-slate-200 print:border-slate-400"
      >
        <div>
        ...
        <table class="w-full">
          <thead>
            <tr class="border-b-2 border-slate-200">
              <th class="text-left py-3 text-sm font-semibold text-slate-900">
                Item
              </th>
              <th class="text-center py-3 text-sm font-semibold text-slate-900">
                SKU
              </th>
              <th class="text-center py-3 text-sm font-semibold text-slate-900">
                Qty
              </th>
              <th class="text-right py-3 text-sm font-semibold text-slate-900">
                Price
              </th>
              <th class="text-right py-3 text-sm font-semibold text-slate-900">
                Total
          ...
          <tbody>
            ...
            >
              <td class="py-4">
                <div>
                  ...
                  <div class="text-xs text-slate-500 mt-1 space-y-1">
                    <p>
                      {{ item.gemstoneType }} • {{ item.weight }}ct •
                      {{ item.cut }}
                    </p>
              ...
              <td class="text-center py-4 text-sm text-slate-600">
                {{ item.sku }}
              </td>
              <td class="text-center py-4 text-sm text-slate-600">
                {{ item.quantity }}
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <div class="text-sm text-slate-600">
              <p>
                ...
                {{ order.paymentMethod?.slice(-4) || "xxxx" }}
              </p>
          ...
          <div>
            ...
            <div class="text-xs text-slate-500">
              ...
              <p>
                Certificate numbers and details are provided with each item.
              </p>
      ...
      <!-- Footer -->
      <div
        class="mt-8 pt-8 border-t border-slate-200 text-center text-xs text-slate-500"
      >
    ...
    <!-- Print Actions -->
    <div
      class="flex justify-end space-x-3 p-6 border-t border-slate-200 print:hidden"
    >
      <button
        @click="$emit('close')"
